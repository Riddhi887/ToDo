...
class _KeysState extends State<Keys> {
  ...
  List<Todo> get _orderedTodos {
    ...
    //sorts the copy but keeps the orignal list unchanged in memory
        ...
        Expanded(
          child: Column(
            children: [
              ...
              //tells dart which item to be added in the list
              for (final todo in _orderedTodos)
                CheckableTodoItem(
                  //value key takes a one dynamic value and then used as identification criteria
                  //object key take entire object for reference in this case its todo
